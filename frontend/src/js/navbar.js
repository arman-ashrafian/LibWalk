        ...
        >
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              ...
              <Nav.Link onClick={this.switch_view_announcements}>
                Announcements
              </Nav.Link>
              <Nav.Link onClick={this.switch_view_subscriptions}>
                Subscriptions
              </Nav.Link>
