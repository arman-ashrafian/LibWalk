...
class Announcements extends React.Component {
  ...
  componentDidMount() {
    db.auth().onAuthStateChanged(firebaseUser => {
      ...
      if (
        ...
        console.log(
          "Redirecting to login page, admin should not have announcements."
        );
      }
    });
  }
  ...
  getAnnouncements = () => {
    ...
    if (this.state.announcements !== {}) {
      ...
      console.log(
        "Announcements were already pulled, refresh page to re-load them, else using cache."
      );
    }
    this.render();
  };
  ...
  announcement_card = (clubref, announcement) => {
    return (
      <EachAnn announcement={announcement} clubRef={clubref} {...this.props} />
    );
  };
          ...
          <div className="container centerPage">
            <div className="row centerPage">
              ...
              <div className="col-sm-12 text-center">
                ...
                <h5 className="mb-5">
                  📢 Below Are The Announcements From Organizations You
                  Subscribed To 📢
                </h5>
              </div>
