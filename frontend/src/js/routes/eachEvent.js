    ...
    render() {
        return (
            ...
            <Card className="text-center" style={{width: '18rem'}}>
                <Card.Header>
                    {this.props.admin ? (
                    <a onClick={this.handleEditEvent} style={{fontSize: "15px", float:"right", margin:"0"}}><MdEdit/></a>)
                    :
                    null
                    }
                    <Card.Title style={{fontSize: "30px"}}>
                        <a onClick={this.showEventDetail}>
                ...
                <Card.Body>
                    <Card.Subtitle className="mb-2 text-muted" style={{fontSize: "15px", textAlign: "justify-center"}}>
                        📍 {this.state.eventLocation} <br/>
                        📅 {this.state.eventDate} <br/>
                        🕔 {this.state.eventTime}
                    </Card.Subtitle>
                    <Card.Text>{this.state.eventDescription.slice(0, 100) + "..."}</Card.Text>
                </Card.Body>
            </Card>
            ...
            >
                ...
                <Card border="light" style={{ display: "flex" }}>
                    ...
                    <Card.Subtitle className="mb-2 text-muted" style={{ display:"flex", justifyContent:"space-around", alignItems:"center", fontSize: "25px" }}>
                        📍 {this.state.eventLocation} &nbsp;&nbsp; 📅 {this.state.eventDate} &nbsp;&nbsp; 🕔 {this.state.eventTime}
                    </Card.Subtitle>
                    <Card.Text style={{textAlign:"justify"}}>{this.state.eventDescription}</Card.Text>
